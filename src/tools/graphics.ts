...
export async function LoadAssetGraphics(
	...
	logger: Logger,
): Promise<{ graphics: Immutable<AssetGraphicsWornDefinition>; originalImagesMap: Record<string, string>; }> {
	...
	const graphics: Writable<Immutable<AssetGraphicsWornDefinition>> = {
		type: 'worn',
		layers,
	};
